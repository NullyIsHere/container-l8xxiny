...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-l8xxiny.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-l8xxiny.containers.anotherwebservice.com/
...
```
git clone git@github.com:NullyIsHere/container-l8xxiny.git
cd container-l8xxiny
```
...
```
docker attach container-l8xxiny
```
